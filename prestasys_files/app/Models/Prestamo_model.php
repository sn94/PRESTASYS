...
class  Prestamo_model extends Model
{
    ...
    [ 'FECHA_SOLICI','MONTO_SOLICI','MONTO_APROBADO',  'DEUDOR', 'GARANTE','ESTADO','FECHA_ENTREGA','FECHA_INI_COBRO', 
    'FECHA_APROBACION','FECHA_RECHAZO','CAT_MONTO','FUNCIONARIO', 'FUNCIONARIO_APROB','FUNCIONARIO_RECHA', 'OBSERVACION'];
