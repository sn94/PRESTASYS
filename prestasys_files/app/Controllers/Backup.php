...
class Backup extends BaseController
{
 ...
 //constructor
	...
	public function db_action( $OPERACION="backup" )
	{
		...
		$backupFileName= isset($DATOS->backup_name ) ? $DATOS->backup_name :  ("backups/PrestasysBackup$fecha.sql"); 
		...
		//	shell_exec("cd backups");
			...
			$comando= "mysql -h $hostName -u  $user -p$passw_db emseco_test >  backup\"$backupFileName\"";
