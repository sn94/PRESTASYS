...
<h2 class="text-center">INFORMES - COBROS</h2>

<?php 
echo form_open("prestamo/informes_cobros", ['id'=> "cobro-informe", "class"=>"form-inline", 'onsubmit'=>'buscar(event)' ])
?>
...
<?php echo view("prestamo/informes/informe_grilla"); ?>
</div>
