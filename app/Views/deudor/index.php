...
<div class="card-body">
<a  onclick="callToXlsGen(event, 'CLIENTES')" href="<?=base_url("deudor/list/json")?>">XLS</a>
<a  href="<?=base_url("deudor/list/pdf")?>">PDF</a>
...
<table id="tabla-funcionarios" class="table table-bordered table-stripped">
  ...
  <tr>
  <th></th><th></th><th></th>
  <th>CI°</th><th>NOMBRES</th><th>CIUDAD</th><th>TELÉFONO</th>
...
<td><a href="<?= base_url("deudor/view/$i->IDNRO")?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
